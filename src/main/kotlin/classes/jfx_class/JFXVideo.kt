...
class JFXVideo(path: String, mediaPlayer: EmbeddedMediaPlayer, mediaPlayerFactory: MediaPlayerFactory): JFXPanel() {
    ...
    private fun initialiseJavaFXScene() {
        ...
        GlobalScope.launch(Dispatchers.IO){
            myMediaPlayer!!.controls().stop()
            myMediaPlayer!!.media().start(myPath, ":start-time=100")
